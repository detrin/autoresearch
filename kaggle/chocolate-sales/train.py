...
drop_cols = [TARGET, "order_id", "product_id", "store_id", "customer_id", "order_date"]
...
with mlflow.start_run():
    ...
    mlflow.log_param("description", "baseline: merged tables, label-encoded cats, linear regression")
